...
// newBasePath constructs the base path for API requests based on the bot token.
func newBasePath(token string) string {
	return "bot" + token
}

// Updates retrieves updates from the Telegram Bot API.
...
// SendMessage sends a message to a chat via the Telegram Bot API.
...
// doRequest executes a request to the Telegram Bot API.
